...
var EverythingOAuthSession = class {
	...
	async persist(item) {
		...
		if (useOfficial && official.liveModelsUrl !== void 0) {
			...
			if (token !== void 0) try {
				const { fetchLiveModelIds } = await import("./live-models-DFdXrevT.js");
