...
function DshAuthEveryingSettings({ t }) {
	if (t === void 0) throw new Error("dsh-auth-everying settings requires t");
	ensureCss();
...
const name = "dsh-auth-everying-client";
...
function apply(ctx) {
	...
	ctx.effect(() => ctx.locale.register(namespace, {
		zh,
		en
	}), "dsh-auth-everying: settings copy");
